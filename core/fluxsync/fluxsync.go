...
func WaitForSync(ctx context.Context, c client.Client, key client.ObjectKey, obj Reconcilable) error {
	if err := wait.PollUntilContextTimeout(context.Background(), k8sPollInterval, k8sTimeout, true, checkResourceSync(ctx, c, key, obj, obj.GetLastHandledReconcileRequest())); err != nil {
...
func checkResourceSync(ctx context.Context, c client.Client, name client.ObjectKey, obj Reconcilable, lastReconcile string) func(context.Context) (bool, error) {
