...
type FakeCluster struct {
	...
	SetConfigStub        func(*rest.Config) error
...
func (fake *FakeCluster) SetConfig(arg1 *rest.Config) error {
...
func (fake *FakeCluster) SetConfigCallCount() int {
	fake.setConfigMutex.RLock()
	defer fake.setConfigMutex.RUnlock()
	return len(fake.setConfigArgsForCall)
}

func (fake *FakeCluster) SetConfigCalls(stub func(*rest.Config) error) {
	fake.setConfigMutex.Lock()
	defer fake.setConfigMutex.Unlock()
	fake.SetConfigStub = stub
}

func (fake *FakeCluster) SetConfigArgsForCall(i int) *rest.Config {
	fake.setConfigMutex.RLock()
	defer fake.setConfigMutex.RUnlock()
...
func (fake *FakeCluster) SetConfigReturns(result1 error) {
	fake.setConfigMutex.Lock()
	defer fake.setConfigMutex.Unlock()
...
func (fake *FakeCluster) SetConfigReturnsOnCall(i int, result1 error) {
	fake.setConfigMutex.Lock()
	defer fake.setConfigMutex.Unlock()
	fake.SetConfigStub = nil
