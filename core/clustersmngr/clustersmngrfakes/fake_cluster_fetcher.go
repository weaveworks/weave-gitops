...
type FakeClusterFetcher struct {
	FetchStub        func(context.Context) ([]clusters.Cluster, error)
...
func (fake *FakeClusterFetcher) Fetch(arg1 context.Context) ([]clusters.Cluster, error) {
...
func (fake *FakeClusterFetcher) FetchCalls(stub func(context.Context) ([]clusters.Cluster, error)) {
	fake.fetchMutex.Lock()
...
func (fake *FakeClusterFetcher) FetchReturns(result1 []clusters.Cluster, result2 error) {
	fake.fetchMutex.Lock()
	defer fake.fetchMutex.Unlock()
	fake.FetchStub = nil
...
func (fake *FakeClusterFetcher) FetchReturnsOnCall(i int, result1 []clusters.Cluster, result2 error) {
	fake.fetchMutex.Lock()
	defer fake.fetchMutex.Unlock()
	fake.FetchStub = nil
