...
type FakeClientsPool struct {
	AddStub        func(client.Client, clustersmngr.Cluster) error
...
func (fake *FakeClientsPool) Add(arg1 client.Client, arg2 clustersmngr.Cluster) error {
	fake.addMutex.Lock()
...
func (fake *FakeClientsPool) AddCalls(stub func(client.Client, clustersmngr.Cluster) error) {
	fake.addMutex.Lock()
	defer fake.addMutex.Unlock()
	fake.AddStub = stub
}

func (fake *FakeClientsPool) AddArgsForCall(i int) (client.Client, clustersmngr.Cluster) {
	fake.addMutex.RLock()
	defer fake.addMutex.RUnlock()
