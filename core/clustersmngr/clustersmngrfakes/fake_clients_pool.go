...
type FakeClientsPool struct {
	AddStub        func(*auth.UserPrincipal, clustersmngr.Cluster) error
...
func (fake *FakeClientsPool) Add(arg1 *auth.UserPrincipal, arg2 clustersmngr.Cluster) error {
	fake.addMutex.Lock()
...
func (fake *FakeClientsPool) AddCalls(stub func(*auth.UserPrincipal, clustersmngr.Cluster) error) {
	fake.addMutex.Lock()
	defer fake.addMutex.Unlock()
	fake.AddStub = stub
}

func (fake *FakeClientsPool) AddArgsForCall(i int) (*auth.UserPrincipal, clustersmngr.Cluster) {
	fake.addMutex.RLock()
	defer fake.addMutex.RUnlock()
