...
type FakeClientsPool struct {
	AddStub        func(client.Client, clusters.Cluster) error
	addMutex       sync.RWMutex
	addArgsForCall []struct {
		arg1 client.Client
		arg2 clusters.Cluster
	}
	addReturns struct {
		result1 error
	}
...
func (fake *FakeClientsPool) Add(arg1 client.Client, arg2 clusters.Cluster) error {
	fake.addMutex.Lock()
...
func (fake *FakeClientsPool) AddCalls(stub func(client.Client, clusters.Cluster) error) {
	fake.addMutex.Lock()
	defer fake.addMutex.Unlock()
	fake.AddStub = stub
}

func (fake *FakeClientsPool) AddArgsForCall(i int) (client.Client, clusters.Cluster) {
	fake.addMutex.RLock()
	defer fake.addMutex.RUnlock()
