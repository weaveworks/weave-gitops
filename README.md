...
To run a single test, you will need to set the KUBEBUILDER_ASSESTS environrment variable to point to the directory containing our mock K8s objects.  
```bash
export KUBEBUILDER_ASSETS=../../tools/bin/envtest
