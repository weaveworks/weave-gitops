...
type FakeGitProviderHandler struct {
	...
	OauthConfigStub        func() *oauth2.Config
...
func (fake *FakeGitProviderHandler) OauthConfig() *oauth2.Config {
...
func (fake *FakeGitProviderHandler) OauthConfigCalls(stub func() *oauth2.Config) {
	fake.oauthConfigMutex.Lock()
	defer fake.oauthConfigMutex.Unlock()
	fake.OauthConfigStub = stub
}

func (fake *FakeGitProviderHandler) OauthConfigReturns(result1 *oauth2.Config) {
	fake.oauthConfigMutex.Lock()
	defer fake.oauthConfigMutex.Unlock()
...
func (fake *FakeGitProviderHandler) OauthConfigReturnsOnCall(i int, result1 *oauth2.Config) {
	fake.oauthConfigMutex.Lock()
	defer fake.oauthConfigMutex.Unlock()
	fake.OauthConfigStub = nil
