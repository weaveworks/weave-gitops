...
type LoginReq struct {
	...
	State string `protobuf:"bytes,1,opt,name=state,proto3" json:"state,omitempty"` // The state that will be persisted in the URL query through the Oauth2 flow
}
...
type LoginRes struct {
	...
	RedirectUrl string `protobuf:"bytes,1,opt,name=redirect_url,json=redirectUrl,proto3" json:"redirect_url,omitempty"` // The page to redirect a user to recieve a token
}
...
type Application struct {
	...
	Type DeploymentType `protobuf:"varint,2,opt,name=type,proto3,enum=gitops.DeploymentType" json:"type,omitempty"`
}
...
func (x *Application) GetType() DeploymentType {
	if x != nil {
		return x.Type
	}
...
type AddApplicationReq struct {
	...
	Owner          string         `protobuf:"bytes,1,opt,name=owner,proto3" json:"owner,omitempty"`                                                                     // The owner or org of the source git repo
	Name           string         `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`                                                                       // The Name of the application
	Url            string         `protobuf:"bytes,3,opt,name=url,proto3" json:"url,omitempty"`                                                                         // The URL of the source git repository
	Path           string         `protobuf:"bytes,4,opt,name=path,proto3" json:"path,omitempty"`                                                                       // The path within the git repository that holds the files
	Branch         string         `protobuf:"bytes,5,opt,name=branch,proto3" json:"branch,omitempty"`                                                                   // The git branch to use
	DeploymentType DeploymentType `protobuf:"varint,6,opt,name=deployment_type,json=deploymentType,proto3,enum=gitops.DeploymentType" json:"deployment_type,omitempty"` // The type of deployment
	PrivateKey     string         `protobuf:"bytes,7,opt,name=private_key,json=privateKey,proto3" json:"private_key,omitempty"`                                         // The private key for creating this repo
	DryRun         bool           `protobuf:"varint,8,opt,name=dry_run,json=dryRun,proto3" json:"dry_run,omitempty"`                                                    // Whether or not to do a dry run
	Private        bool           `protobuf:"varint,9,opt,name=private,proto3" json:"private,omitempty"`                                                                // Whether or not the repo is private
	Namespace      string         `protobuf:"bytes,10,opt,name=namespace,proto3" json:"namespace,omitempty"`                                                            // The target namespace for this application
	Dir            string         `protobuf:"bytes,11,opt,name=dir,proto3" json:"dir,omitempty"`                                                                        // The ...dir?
}
...
var file_pkg_rpc_gitops_gitops_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x74, 0x55, 0x72, 0x6c, 0x22, 0x4d, 0x0a, 0x0b, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63,
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16, 0x2e, 0x67, 0x69, 0x74, 0x6f, 0x70, 0x73,
	0x2e, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52,
	0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xc0, 0x02, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x41, 0x70, 0x70,
	0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x14, 0x0a, 0x05, 0x6f,
	...
	,
...
var file_pkg_rpc_gitops_gitops_proto_depIdxs = []int32{
	0, // 0: gitops.Application.type:type_name -> gitops.DeploymentType
	0, // 1: gitops.AddApplicationReq.deployment_type:type_name -> gitops.DeploymentType
	3, // 2: gitops.AddApplicationRes.application:type_name -> gitops.Application
	1, // 3: gitops.GitOps.Login:input_type -> gitops.LoginReq
	4, // 4: gitops.GitOps.AddApplication:input_type -> gitops.AddApplicationReq
	2, // 5: gitops.GitOps.Login:output_type -> gitops.LoginRes
	5, // 6: gitops.GitOps.AddApplication:output_type -> gitops.AddApplicationRes
