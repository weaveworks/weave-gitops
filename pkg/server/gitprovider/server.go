...
type gitAuthServer struct {
	pb.UnimplementedGitProviderAuthServer
...
// An GitAuthConfig allows for the customization of an ApplicationsServer.
...
// NewGitAuthServer creates a grpc Applications server
func NewGitAuthServer(cfg *GitAuthConfig, setters ...AuthOption) pb.GitProviderAuthServer {
...
// DefaultGitAuthServerConfig creates a populated config with the dependencies for a Server
func DefaultGitAuthServerConfig(log logr.Logger) (*GitAuthConfig, error) {
...
func (s *gitAuthServer) GetGithubDeviceCode(ctx context.Context, msg *pb.GetGithubDeviceCodeRequest) (*pb.GetGithubDeviceCodeResponse, error) {
...
func (s *gitAuthServer) GetGithubAuthStatus(ctx context.Context, msg *pb.GetGithubAuthStatusRequest) (*pb.GetGithubAuthStatusResponse, error) {
...
func (s *gitAuthServer) Authenticate(_ context.Context, msg *pb.AuthenticateRequest) (*pb.AuthenticateResponse, error) {
...
func (s *gitAuthServer) ParseRepoURL(ctx context.Context, msg *pb.ParseRepoURLRequest) (*pb.ParseRepoURLResponse, error) {
...
func (s *gitAuthServer) GetGitlabAuthURL(ctx context.Context, msg *pb.GetGitlabAuthURLRequest) (*pb.GetGitlabAuthURLResponse, error) {
...
func (s *gitAuthServer) AuthorizeGitlab(ctx context.Context, msg *pb.AuthorizeGitlabRequest) (*pb.AuthorizeGitlabResponse, error) {
...
func (s *gitAuthServer) ValidateProviderToken(ctx context.Context, msg *pb.ValidateProviderTokenRequest) (*pb.ValidateProviderTokenResponse, error) {
...
// TODO this belongs on the auth server? or maybe core?
func (s *gitAuthServer) GetFeatureFlags(ctx context.Context, msg *pb.GetFeatureFlagsRequest) (*pb.GetFeatureFlagsResponse, error) {
...
func findValidator(provider pb.GitProvider, s *gitAuthServer) (auth.ProviderTokenValidator, error) {
	switch provider {
