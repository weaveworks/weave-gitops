...
func (*SuspendReqObj) Descriptor() ([]byte, []int) {
	return file_api_core_types_proto_rawDescGZIP(), []int{19}
}
...
func (x *Crd_Name) Reset() {
	*x = Crd_Name{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_core_types_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_api_core_types_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x69, 0x64, 0x22, 0x97, 0x01, 0x0a, 0x0d, 0x53, 0x75, 0x73,
	0x70, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x71, 0x4f, 0x62, 0x6a, 0x12, 0x32, 0x0a, 0x04, 0x6b, 0x69,
	...
	0x12, 0x20, 0x0a, 0x0b, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x4e, 0x61,
	0x6d, 0x65, 0x2a, 0xb6, 0x01, 0x0a, 0x0e, 0x46, 0x6c, 0x75, 0x78, 0x4f, 0x62, 0x6a, 0x65, 0x63,
	...
	0x65, 0x72, 0x10, 0x06, 0x12, 0x15, 0x0a, 0x11, 0x4b, 0x69, 0x6e, 0x64, 0x4f, 0x43, 0x49, 0x52,
	0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x10, 0x07, 0x2a, 0x2a, 0x0a, 0x12, 0x48,
	0x65, 0x6c, 0x6d, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x54, 0x79, 0x70,
...
var file_api_core_types_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_api_core_types_proto_goTypes = []interface{}{
	...
	(*SuspendReqObj)(nil),      // 22: gitops_core.v1.SuspendReqObj
	(*Crd_Name)(nil),           // 23: gitops_core.v1.Crd.Name
	nil,                        // 24: gitops_core.v1.Namespace.AnnotationsEntry
	nil,                        // 25: gitops_core.v1.Namespace.LabelsEntry
}
var file_api_core_types_proto_depIdxs = []int32{
	...
	23, // 24: gitops_core.v1.Crd.name:type_name -> gitops_core.v1.Crd.Name
	...
	24, // 27: gitops_core.v1.Namespace.annotations:type_name -> gitops_core.v1.Namespace.AnnotationsEntry
	25, // 28: gitops_core.v1.Namespace.labels:type_name -> gitops_core.v1.Namespace.LabelsEntry
	0,  // 29: gitops_core.v1.SuspendReqObj.kind:type_name -> gitops_core.v1.FluxObjectKind
...
func file_api_core_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_core_types_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
