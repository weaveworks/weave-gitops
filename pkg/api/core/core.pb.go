...
var file_api_core_core_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x2e, 0x41, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4b, 0x69,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0xc3, 0x0f, 0x0a, 0x04, 0x43, 0x6f, 0x72, 0x65, 0x12, 0x87, 0x01,
	...
	0x76, 0x31, 0x2f, 0x73, 0x79, 0x6e, 0x63, 0x3a, 0x01, 0x2a, 0x42, 0xa4, 0x01, 0x5a, 0x2b, 0x67,
...
var file_api_core_core_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_api_core_core_proto_goTypes = []interface{}{
	...
	(*SyncAutomationRequest)(nil),          // 28: gitops_core.v1.SyncAutomationRequest
	(*SyncAutomationResponse)(nil),         // 29: gitops_core.v1.SyncAutomationResponse
	(*Kustomization)(nil),                  // 30: gitops_core.v1.Kustomization
	(*HelmRelease)(nil),                    // 31: gitops_core.v1.HelmRelease
	(*GitRepository)(nil),                  // 32: gitops_core.v1.GitRepository
	(*HelmRepository)(nil),                 // 33: gitops_core.v1.HelmRepository
	(*Bucket)(nil),                         // 34: gitops_core.v1.Bucket
	(*Deployment)(nil),                     // 35: gitops_core.v1.Deployment
	(*HelmChart)(nil),                      // 36: gitops_core.v1.HelmChart
	(AutomationKind)(0),                    // 37: gitops_core.v1.AutomationKind
	...
	(*ObjectReference)(nil),                // 41: gitops_core.v1.ObjectReference
	(*Event)(nil),                          // 42: gitops_core.v1.Event
}
var file_api_core_core_proto_depIdxs = []int32{
	30, // 0: gitops_core.v1.ListKustomizationsResponse.kustomizations:type_name -> gitops_core.v1.Kustomization
	31, // 1: gitops_core.v1.ListHelmReleasesResponse.helm_releases:type_name -> gitops_core.v1.HelmRelease
	31, // 2: gitops_core.v1.GetHelmReleaseResponse.helm_release:type_name -> gitops_core.v1.HelmRelease
	32, // 3: gitops_core.v1.ListGitRepositoriesResponse.git_repositories:type_name -> gitops_core.v1.GitRepository
	33, // 4: gitops_core.v1.ListHelmRepositoriesResponse.helm_repositories:type_name -> gitops_core.v1.HelmRepository
	34, // 5: gitops_core.v1.ListBucketsResponse.buckets:type_name -> gitops_core.v1.Bucket
	35, // 6: gitops_core.v1.ListFluxRuntimeObjectsResponse.deployments:type_name -> gitops_core.v1.Deployment
	36, // 7: gitops_core.v1.ListHelmChartsResponse.helm_charts:type_name -> gitops_core.v1.HelmChart
	30, // 8: gitops_core.v1.GetKustomizationResponse.kustomization:type_name -> gitops_core.v1.Kustomization
	37, // 9: gitops_core.v1.GetReconciledObjectsRequest.automationKind:type_name -> gitops_core.v1.AutomationKind
	38, // 10: gitops_core.v1.GetReconciledObjectsRequest.kinds:type_name -> gitops_core.v1.GroupVersionKind
	39, // 11: gitops_core.v1.GetReconciledObjectsResponse.objects:type_name -> gitops_core.v1.UnstructuredObject
	38, // 12: gitops_core.v1.GetChildObjectsRequest.groupVersionKind:type_name -> gitops_core.v1.GroupVersionKind
	39, // 13: gitops_core.v1.GetChildObjectsResponse.objects:type_name -> gitops_core.v1.UnstructuredObject
	40, // 14: gitops_core.v1.ListNamespacesResponse.namespaces:type_name -> gitops_core.v1.Namespace
	41, // 15: gitops_core.v1.ListFluxEventsRequest.involvedObject:type_name -> gitops_core.v1.ObjectReference
	42, // 16: gitops_core.v1.ListFluxEventsResponse.events:type_name -> gitops_core.v1.Event
	37, // 17: gitops_core.v1.SyncAutomationRequest.kind:type_name -> gitops_core.v1.AutomationKind
	0,  // 18: gitops_core.v1.Core.ListKustomizations:input_type -> gitops_core.v1.ListKustomizationsRequest
	16, // 19: gitops_core.v1.Core.GetKustomization:input_type -> gitops_core.v1.GetKustomizationRequest
	2,  // 20: gitops_core.v1.Core.ListHelmReleases:input_type -> gitops_core.v1.ListHelmReleasesRequest
	4,  // 21: gitops_core.v1.Core.GetHelmRelease:input_type -> gitops_core.v1.GetHelmReleaseRequest
	6,  // 22: gitops_core.v1.Core.ListGitRepositories:input_type -> gitops_core.v1.ListGitRepositoriesRequest
	14, // 23: gitops_core.v1.Core.ListHelmCharts:input_type -> gitops_core.v1.ListHelmChartsRequest
	8,  // 24: gitops_core.v1.Core.ListHelmRepositories:input_type -> gitops_core.v1.ListHelmRepositoriesRequest
	10, // 25: gitops_core.v1.Core.ListBuckets:input_type -> gitops_core.v1.ListBucketRequest
	12, // 26: gitops_core.v1.Core.ListFluxRuntimeObjects:input_type -> gitops_core.v1.ListFluxRuntimeObjectsRequest
	18, // 27: gitops_core.v1.Core.GetReconciledObjects:input_type -> gitops_core.v1.GetReconciledObjectsRequest
	20, // 28: gitops_core.v1.Core.GetChildObjects:input_type -> gitops_core.v1.GetChildObjectsRequest
	22, // 29: gitops_core.v1.Core.GetFluxNamespace:input_type -> gitops_core.v1.GetFluxNamespaceRequest
	24, // 30: gitops_core.v1.Core.ListNamespaces:input_type -> gitops_core.v1.ListNamespacesRequest
	26, // 31: gitops_core.v1.Core.ListFluxEvents:input_type -> gitops_core.v1.ListFluxEventsRequest
	28, // 32: gitops_core.v1.Core.SyncAutomation:input_type -> gitops_core.v1.SyncAutomationRequest
	1,  // 33: gitops_core.v1.Core.ListKustomizations:output_type -> gitops_core.v1.ListKustomizationsResponse
	17, // 34: gitops_core.v1.Core.GetKustomization:output_type -> gitops_core.v1.GetKustomizationResponse
	3,  // 35: gitops_core.v1.Core.ListHelmReleases:output_type -> gitops_core.v1.ListHelmReleasesResponse
	5,  // 36: gitops_core.v1.Core.GetHelmRelease:output_type -> gitops_core.v1.GetHelmReleaseResponse
	7,  // 37: gitops_core.v1.Core.ListGitRepositories:output_type -> gitops_core.v1.ListGitRepositoriesResponse
	15, // 38: gitops_core.v1.Core.ListHelmCharts:output_type -> gitops_core.v1.ListHelmChartsResponse
	9,  // 39: gitops_core.v1.Core.ListHelmRepositories:output_type -> gitops_core.v1.ListHelmRepositoriesResponse
	11, // 40: gitops_core.v1.Core.ListBuckets:output_type -> gitops_core.v1.ListBucketsResponse
	13, // 41: gitops_core.v1.Core.ListFluxRuntimeObjects:output_type -> gitops_core.v1.ListFluxRuntimeObjectsResponse
	19, // 42: gitops_core.v1.Core.GetReconciledObjects:output_type -> gitops_core.v1.GetReconciledObjectsResponse
	21, // 43: gitops_core.v1.Core.GetChildObjects:output_type -> gitops_core.v1.GetChildObjectsResponse
	23, // 44: gitops_core.v1.Core.GetFluxNamespace:output_type -> gitops_core.v1.GetFluxNamespaceResponse
	25, // 45: gitops_core.v1.Core.ListNamespaces:output_type -> gitops_core.v1.ListNamespacesResponse
	27, // 46: gitops_core.v1.Core.ListFluxEvents:output_type -> gitops_core.v1.ListFluxEventsResponse
	29, // 47: gitops_core.v1.Core.SyncAutomation:output_type -> gitops_core.v1.SyncAutomationResponse
