...
var file_api_core_core_proto_rawDesc = []byte{
	...
	0x6d, 0x43, 0x68, 0x61, 0x72, 0x74, 0x73, 0x22, 0x4b, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x4b, 0x75,
	...
	0x70, 0x61, 0x63, 0x65, 0x22, 0x5f, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x4b, 0x75, 0x73, 0x74, 0x6f,
	...
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x67, 0x69, 0x74, 0x6f, 0x70, 0x73,
	0x5f, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4b, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69,
	0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0d, 0x6b, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xe3, 0x01, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x52, 0x65, 0x63,
	...
	0x4b, 0x69, 0x6e, 0x64, 0x52, 0x05, 0x6b, 0x69, 0x6e, 0x64, 0x73, 0x22, 0x5c, 0x0a, 0x1c, 0x47,
	...
	0x52, 0x07, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x22, 0xa2, 0x01, 0x0a, 0x16, 0x47, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x55, 0x69, 0x64, 0x22, 0x57,
	...
	0x6d, 0x65, 0x32, 0xde, 0x0b, 0x0a, 0x04, 0x43, 0x6f, 0x72, 0x65, 0x12, 0x87, 0x01, 0x0a, 0x12,
	...
	0x73, 0x12, 0x8b, 0x01, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x47, 0x69, 0x74, 0x52, 0x65, 0x70,
	...
	0x75, 0x63, 0x6b, 0x65, 0x74, 0x73, 0x12, 0x99, 0x01, 0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74, 0x46,
	...
	0x3a, 0x01, 0x2a, 0x42, 0xa4, 0x01, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_api_core_core_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_api_core_core_proto_goTypes = []interface{}{
	...
	(*GetKustomizationRequest)(nil),        // 14: gitops_core.v1.GetKustomizationRequest
	(*GetKustomizationResponse)(nil),       // 15: gitops_core.v1.GetKustomizationResponse
	(*GetReconciledObjectsRequest)(nil),    // 16: gitops_core.v1.GetReconciledObjectsRequest
	(*GetReconciledObjectsResponse)(nil),   // 17: gitops_core.v1.GetReconciledObjectsResponse
	(*GetChildObjectsRequest)(nil),         // 18: gitops_core.v1.GetChildObjectsRequest
	(*GetChildObjectsResponse)(nil),        // 19: gitops_core.v1.GetChildObjectsResponse
	(*GetFluxNamespaceRequest)(nil),        // 20: gitops_core.v1.GetFluxNamespaceRequest
	(*GetFluxNamespaceResponse)(nil),       // 21: gitops_core.v1.GetFluxNamespaceResponse
	(*Kustomization)(nil),                  // 22: gitops_core.v1.Kustomization
	(*HelmRelease)(nil),                    // 23: gitops_core.v1.HelmRelease
	(*GitRepository)(nil),                  // 24: gitops_core.v1.GitRepository
	(*HelmRepository)(nil),                 // 25: gitops_core.v1.HelmRepository
	(*Bucket)(nil),                         // 26: gitops_core.v1.Bucket
	(*Deployment)(nil),                     // 27: gitops_core.v1.Deployment
	(*HelmChart)(nil),                      // 28: gitops_core.v1.HelmChart
	(AutomationKind)(0),                    // 29: gitops_core.v1.AutomationKind
	(*GroupVersionKind)(nil),               // 30: gitops_core.v1.GroupVersionKind
	(*UnstructuredObject)(nil),             // 31: gitops_core.v1.UnstructuredObject
}
var file_api_core_core_proto_depIdxs = []int32{
	22, // 0: gitops_core.v1.ListKustomizationsResponse.kustomizations:type_name -> gitops_core.v1.Kustomization
	23, // 1: gitops_core.v1.ListHelmReleasesResponse.helm_releases:type_name -> gitops_core.v1.HelmRelease
	24, // 2: gitops_core.v1.ListGitRepositoriesResponse.git_repositories:type_name -> gitops_core.v1.GitRepository
	25, // 3: gitops_core.v1.ListHelmRepositoriesResponse.helm_repositories:type_name -> gitops_core.v1.HelmRepository
	26, // 4: gitops_core.v1.ListBucketsResponse.buckets:type_name -> gitops_core.v1.Bucket
	27, // 5: gitops_core.v1.ListFluxRuntimeObjectsResponse.deployments:type_name -> gitops_core.v1.Deployment
	28, // 6: gitops_core.v1.ListHelmChartsResponse.helm_charts:type_name -> gitops_core.v1.HelmChart
	22, // 7: gitops_core.v1.GetKustomizationResponse.kustomization:type_name -> gitops_core.v1.Kustomization
	29, // 8: gitops_core.v1.GetReconciledObjectsRequest.automationKind:type_name -> gitops_core.v1.AutomationKind
	30, // 9: gitops_core.v1.GetReconciledObjectsRequest.kinds:type_name -> gitops_core.v1.GroupVersionKind
	31, // 10: gitops_core.v1.GetReconciledObjectsResponse.objects:type_name -> gitops_core.v1.UnstructuredObject
	30, // 11: gitops_core.v1.GetChildObjectsRequest.groupVersionKind:type_name -> gitops_core.v1.GroupVersionKind
	31, // 12: gitops_core.v1.GetChildObjectsResponse.objects:type_name -> gitops_core.v1.UnstructuredObject
	0,  // 13: gitops_core.v1.Core.ListKustomizations:input_type -> gitops_core.v1.ListKustomizationsRequest
	14, // 14: gitops_core.v1.Core.GetKustomization:input_type -> gitops_core.v1.GetKustomizationRequest
	2,  // 15: gitops_core.v1.Core.ListHelmReleases:input_type -> gitops_core.v1.ListHelmReleasesRequest
	4,  // 16: gitops_core.v1.Core.ListGitRepositories:input_type -> gitops_core.v1.ListGitRepositoriesRequest
	12, // 17: gitops_core.v1.Core.ListHelmCharts:input_type -> gitops_core.v1.ListHelmChartsRequest
	6,  // 18: gitops_core.v1.Core.ListHelmRepositories:input_type -> gitops_core.v1.ListHelmRepositoriesRequest
	8,  // 19: gitops_core.v1.Core.ListBuckets:input_type -> gitops_core.v1.ListBucketRequest
	10, // 20: gitops_core.v1.Core.ListFluxRuntimeObjects:input_type -> gitops_core.v1.ListFluxRuntimeObjectsRequest
	16, // 21: gitops_core.v1.Core.GetReconciledObjects:input_type -> gitops_core.v1.GetReconciledObjectsRequest
	18, // 22: gitops_core.v1.Core.GetChildObjects:input_type -> gitops_core.v1.GetChildObjectsRequest
	20, // 23: gitops_core.v1.Core.GetFluxNamespace:input_type -> gitops_core.v1.GetFluxNamespaceRequest
	1,  // 24: gitops_core.v1.Core.ListKustomizations:output_type -> gitops_core.v1.ListKustomizationsResponse
	15, // 25: gitops_core.v1.Core.GetKustomization:output_type -> gitops_core.v1.GetKustomizationResponse
	3,  // 26: gitops_core.v1.Core.ListHelmReleases:output_type -> gitops_core.v1.ListHelmReleasesResponse
	5,  // 27: gitops_core.v1.Core.ListGitRepositories:output_type -> gitops_core.v1.ListGitRepositoriesResponse
	13, // 28: gitops_core.v1.Core.ListHelmCharts:output_type -> gitops_core.v1.ListHelmChartsResponse
	7,  // 29: gitops_core.v1.Core.ListHelmRepositories:output_type -> gitops_core.v1.ListHelmRepositoriesResponse
	9,  // 30: gitops_core.v1.Core.ListBuckets:output_type -> gitops_core.v1.ListBucketsResponse
	11, // 31: gitops_core.v1.Core.ListFluxRuntimeObjects:output_type -> gitops_core.v1.ListFluxRuntimeObjectsResponse
	17, // 32: gitops_core.v1.Core.GetReconciledObjects:output_type -> gitops_core.v1.GetReconciledObjectsResponse
	19, // 33: gitops_core.v1.Core.GetChildObjects:output_type -> gitops_core.v1.GetChildObjectsResponse
	21, // 34: gitops_core.v1.Core.GetFluxNamespace:output_type -> gitops_core.v1.GetFluxNamespaceResponse
