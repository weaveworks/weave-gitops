...
var file_api_core_core_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0xdf, 0x0c, 0x0a, 0x04, 0x43, 0x6f, 0x72, 0x65,
	...
	0x65, 0x2f, 0x66, 0x6c, 0x75, 0x78, 0x3a, 0x01, 0x2a, 0x42, 0xa4, 0x01, 0x5a, 0x2b, 0x67, 0x69,
...
var file_api_core_core_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_api_core_core_proto_goTypes = []interface{}{
	...
	(*Kustomization)(nil),                  // 24: gitops_core.v1.Kustomization
	(*HelmRelease)(nil),                    // 25: gitops_core.v1.HelmRelease
	(*GitRepository)(nil),                  // 26: gitops_core.v1.GitRepository
	(*HelmRepository)(nil),                 // 27: gitops_core.v1.HelmRepository
	(*Bucket)(nil),                         // 28: gitops_core.v1.Bucket
	(*Deployment)(nil),                     // 29: gitops_core.v1.Deployment
	(*HelmChart)(nil),                      // 30: gitops_core.v1.HelmChart
	(AutomationKind)(0),                    // 31: gitops_core.v1.AutomationKind
	(*GroupVersionKind)(nil),               // 32: gitops_core.v1.GroupVersionKind
	(*UnstructuredObject)(nil),             // 33: gitops_core.v1.UnstructuredObject
}
var file_api_core_core_proto_depIdxs = []int32{
	24, // 0: gitops_core.v1.ListKustomizationsResponse.kustomizations:type_name -> gitops_core.v1.Kustomization
	25, // 1: gitops_core.v1.ListHelmReleasesResponse.helm_releases:type_name -> gitops_core.v1.HelmRelease
	25, // 2: gitops_core.v1.GetHelmReleaseResponse.helm_release:type_name -> gitops_core.v1.HelmRelease
	26, // 3: gitops_core.v1.ListGitRepositoriesResponse.git_repositories:type_name -> gitops_core.v1.GitRepository
	27, // 4: gitops_core.v1.ListHelmRepositoriesResponse.helm_repositories:type_name -> gitops_core.v1.HelmRepository
	28, // 5: gitops_core.v1.ListBucketsResponse.buckets:type_name -> gitops_core.v1.Bucket
	29, // 6: gitops_core.v1.ListFluxRuntimeObjectsResponse.deployments:type_name -> gitops_core.v1.Deployment
	30, // 7: gitops_core.v1.ListHelmChartsResponse.helm_charts:type_name -> gitops_core.v1.HelmChart
	24, // 8: gitops_core.v1.GetKustomizationResponse.kustomization:type_name -> gitops_core.v1.Kustomization
	31, // 9: gitops_core.v1.GetReconciledObjectsRequest.automationKind:type_name -> gitops_core.v1.AutomationKind
	32, // 10: gitops_core.v1.GetReconciledObjectsRequest.kinds:type_name -> gitops_core.v1.GroupVersionKind
	33, // 11: gitops_core.v1.GetReconciledObjectsResponse.objects:type_name -> gitops_core.v1.UnstructuredObject
	32, // 12: gitops_core.v1.GetChildObjectsRequest.groupVersionKind:type_name -> gitops_core.v1.GroupVersionKind
	33, // 13: gitops_core.v1.GetChildObjectsResponse.objects:type_name -> gitops_core.v1.UnstructuredObject
	0,  // 14: gitops_core.v1.Core.ListKustomizations:input_type -> gitops_core.v1.ListKustomizationsRequest
	16, // 15: gitops_core.v1.Core.GetKustomization:input_type -> gitops_core.v1.GetKustomizationRequest
	2,  // 16: gitops_core.v1.Core.ListHelmReleases:input_type -> gitops_core.v1.ListHelmReleasesRequest
	4,  // 17: gitops_core.v1.Core.GetHelmRelease:input_type -> gitops_core.v1.GetHelmReleaseRequest
	6,  // 18: gitops_core.v1.Core.ListGitRepositories:input_type -> gitops_core.v1.ListGitRepositoriesRequest
	14, // 19: gitops_core.v1.Core.ListHelmCharts:input_type -> gitops_core.v1.ListHelmChartsRequest
	8,  // 20: gitops_core.v1.Core.ListHelmRepositories:input_type -> gitops_core.v1.ListHelmRepositoriesRequest
	10, // 21: gitops_core.v1.Core.ListBuckets:input_type -> gitops_core.v1.ListBucketRequest
	12, // 22: gitops_core.v1.Core.ListFluxRuntimeObjects:input_type -> gitops_core.v1.ListFluxRuntimeObjectsRequest
	18, // 23: gitops_core.v1.Core.GetReconciledObjects:input_type -> gitops_core.v1.GetReconciledObjectsRequest
	20, // 24: gitops_core.v1.Core.GetChildObjects:input_type -> gitops_core.v1.GetChildObjectsRequest
	22, // 25: gitops_core.v1.Core.GetFluxNamespace:input_type -> gitops_core.v1.GetFluxNamespaceRequest
	1,  // 26: gitops_core.v1.Core.ListKustomizations:output_type -> gitops_core.v1.ListKustomizationsResponse
	17, // 27: gitops_core.v1.Core.GetKustomization:output_type -> gitops_core.v1.GetKustomizationResponse
	3,  // 28: gitops_core.v1.Core.ListHelmReleases:output_type -> gitops_core.v1.ListHelmReleasesResponse
	5,  // 29: gitops_core.v1.Core.GetHelmRelease:output_type -> gitops_core.v1.GetHelmReleaseResponse
	7,  // 30: gitops_core.v1.Core.ListGitRepositories:output_type -> gitops_core.v1.ListGitRepositoriesResponse
	15, // 31: gitops_core.v1.Core.ListHelmCharts:output_type -> gitops_core.v1.ListHelmChartsResponse
	9,  // 32: gitops_core.v1.Core.ListHelmRepositories:output_type -> gitops_core.v1.ListHelmRepositoriesResponse
	11, // 33: gitops_core.v1.Core.ListBuckets:output_type -> gitops_core.v1.ListBucketsResponse
	13, // 34: gitops_core.v1.Core.ListFluxRuntimeObjects:output_type -> gitops_core.v1.ListFluxRuntimeObjectsResponse
	19, // 35: gitops_core.v1.Core.GetReconciledObjects:output_type -> gitops_core.v1.GetReconciledObjectsResponse
	21, // 36: gitops_core.v1.Core.GetChildObjects:output_type -> gitops_core.v1.GetChildObjectsResponse
	23, // 37: gitops_core.v1.Core.GetFluxNamespace:output_type -> gitops_core.v1.GetFluxNamespaceResponse
