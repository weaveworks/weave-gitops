...
var file_api_core_core_proto_rawDesc = []byte{
	...
	0x08, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0x88, 0x12, 0x0a,
...
var file_api_core_core_proto_goTypes = []interface{}{
	...
	nil,                                    // 43: gitops_core.v1.ListObjectsRequest.LabelsEntry
	nil,                                    // 44: gitops_core.v1.GetFeatureFlagsResponse.FlagsEntry
	nil,                                    // 45: gitops_core.v1.IsCRDAvailableResponse.ClustersEntry
	(*InventoryEntry)(nil),                 // 46: gitops_core.v1.InventoryEntry
	...
	(*GroupVersionKind)(nil),               // 51: gitops_core.v1.GroupVersionKind
	(*Namespace)(nil),                      // 52: gitops_core.v1.Namespace
	(*ObjectRef)(nil),                      // 53: gitops_core.v1.ObjectRef
	(*Event)(nil),                          // 54: gitops_core.v1.Event
}
var file_api_core_core_proto_depIdxs = []int32{
	46, // 0: gitops_core.v1.GetInventoryResponse.entries:type_name -> gitops_core.v1.InventoryEntry
	...
	47, // 7: gitops_core.v1.PolicyValidationParam.value:type_name -> google.protobuf.Any
	48, // 8: gitops_core.v1.ListFluxRuntimeObjectsResponse.deployments:type_name -> gitops_core.v1.Deployment
	11, // 9: gitops_core.v1.ListFluxRuntimeObjectsResponse.errors:type_name -> gitops_core.v1.ListError
	49, // 10: gitops_core.v1.ListFluxCrdsResponse.crds:type_name -> gitops_core.v1.Crd
	11, // 11: gitops_core.v1.ListFluxCrdsResponse.errors:type_name -> gitops_core.v1.ListError
	50, // 12: gitops_core.v1.GetObjectResponse.object:type_name -> gitops_core.v1.Object
	43, // 13: gitops_core.v1.ListObjectsRequest.labels:type_name -> gitops_core.v1.ListObjectsRequest.LabelsEntry
	50, // 14: gitops_core.v1.ListObjectsResponse.objects:type_name -> gitops_core.v1.Object
	11, // 15: gitops_core.v1.ListObjectsResponse.errors:type_name -> gitops_core.v1.ListError
	51, // 16: gitops_core.v1.GetReconciledObjectsRequest.kinds:type_name -> gitops_core.v1.GroupVersionKind
	50, // 17: gitops_core.v1.GetReconciledObjectsResponse.objects:type_name -> gitops_core.v1.Object
	51, // 18: gitops_core.v1.GetChildObjectsRequest.groupVersionKind:type_name -> gitops_core.v1.GroupVersionKind
	50, // 19: gitops_core.v1.GetChildObjectsResponse.objects:type_name -> gitops_core.v1.Object
	52, // 20: gitops_core.v1.ListNamespacesResponse.namespaces:type_name -> gitops_core.v1.Namespace
	53, // 21: gitops_core.v1.ListEventsRequest.involvedObject:type_name -> gitops_core.v1.ObjectRef
	54, // 22: gitops_core.v1.ListEventsResponse.events:type_name -> gitops_core.v1.Event
	53, // 23: gitops_core.v1.SyncFluxObjectRequest.objects:type_name -> gitops_core.v1.ObjectRef
	44, // 24: gitops_core.v1.GetFeatureFlagsResponse.flags:type_name -> gitops_core.v1.GetFeatureFlagsResponse.FlagsEntry
	53, // 25: gitops_core.v1.ToggleSuspendResourceRequest.objects:type_name -> gitops_core.v1.ObjectRef
	39, // 26: gitops_core.v1.GetSessionLogsResponse.logs:type_name -> gitops_core.v1.LogEntry
	45, // 27: gitops_core.v1.IsCRDAvailableResponse.clusters:type_name -> gitops_core.v1.IsCRDAvailableResponse.ClustersEntry
	16, // 28: gitops_core.v1.Core.GetObject:input_type -> gitops_core.v1.GetObjectRequest
	18, // 29: gitops_core.v1.Core.ListObjects:input_type -> gitops_core.v1.ListObjectsRequest
	12, // 30: gitops_core.v1.Core.ListFluxRuntimeObjects:input_type -> gitops_core.v1.ListFluxRuntimeObjectsRequest
	14, // 31: gitops_core.v1.Core.ListFluxCrds:input_type -> gitops_core.v1.ListFluxCrdsRequest
	20, // 32: gitops_core.v1.Core.GetReconciledObjects:input_type -> gitops_core.v1.GetReconciledObjectsRequest
	22, // 33: gitops_core.v1.Core.GetChildObjects:input_type -> gitops_core.v1.GetChildObjectsRequest
	24, // 34: gitops_core.v1.Core.GetFluxNamespace:input_type -> gitops_core.v1.GetFluxNamespaceRequest
	26, // 35: gitops_core.v1.Core.ListNamespaces:input_type -> gitops_core.v1.ListNamespacesRequest
	28, // 36: gitops_core.v1.Core.ListEvents:input_type -> gitops_core.v1.ListEventsRequest
	30, // 37: gitops_core.v1.Core.SyncFluxObject:input_type -> gitops_core.v1.SyncFluxObjectRequest
	32, // 38: gitops_core.v1.Core.GetVersion:input_type -> gitops_core.v1.GetVersionRequest
	34, // 39: gitops_core.v1.Core.GetFeatureFlags:input_type -> gitops_core.v1.GetFeatureFlagsRequest
	36, // 40: gitops_core.v1.Core.ToggleSuspendResource:input_type -> gitops_core.v1.ToggleSuspendResourceRequest
	38, // 41: gitops_core.v1.Core.GetSessionLogs:input_type -> gitops_core.v1.GetSessionLogsRequest
	41, // 42: gitops_core.v1.Core.IsCRDAvailable:input_type -> gitops_core.v1.IsCRDAvailableRequest
	0,  // 43: gitops_core.v1.Core.GetInventory:input_type -> gitops_core.v1.GetInventoryRequest
	3,  // 44: gitops_core.v1.Core.ListPolicyValidations:input_type -> gitops_core.v1.ListPolicyValidationsRequest
	5,  // 45: gitops_core.v1.Core.GetPolicyValidation:input_type -> gitops_core.v1.GetPolicyValidationRequest
	17, // 46: gitops_core.v1.Core.GetObject:output_type -> gitops_core.v1.GetObjectResponse
	19, // 47: gitops_core.v1.Core.ListObjects:output_type -> gitops_core.v1.ListObjectsResponse
	13, // 48: gitops_core.v1.Core.ListFluxRuntimeObjects:output_type -> gitops_core.v1.ListFluxRuntimeObjectsResponse
	15, // 49: gitops_core.v1.Core.ListFluxCrds:output_type -> gitops_core.v1.ListFluxCrdsResponse
	21, // 50: gitops_core.v1.Core.GetReconciledObjects:output_type -> gitops_core.v1.GetReconciledObjectsResponse
	23, // 51: gitops_core.v1.Core.GetChildObjects:output_type -> gitops_core.v1.GetChildObjectsResponse
	25, // 52: gitops_core.v1.Core.GetFluxNamespace:output_type -> gitops_core.v1.GetFluxNamespaceResponse
	27, // 53: gitops_core.v1.Core.ListNamespaces:output_type -> gitops_core.v1.ListNamespacesResponse
	29, // 54: gitops_core.v1.Core.ListEvents:output_type -> gitops_core.v1.ListEventsResponse
	31, // 55: gitops_core.v1.Core.SyncFluxObject:output_type -> gitops_core.v1.SyncFluxObjectResponse
	33, // 56: gitops_core.v1.Core.GetVersion:output_type -> gitops_core.v1.GetVersionResponse
	35, // 57: gitops_core.v1.Core.GetFeatureFlags:output_type -> gitops_core.v1.GetFeatureFlagsResponse
	37, // 58: gitops_core.v1.Core.ToggleSuspendResource:output_type -> gitops_core.v1.ToggleSuspendResourceResponse
	40, // 59: gitops_core.v1.Core.GetSessionLogs:output_type -> gitops_core.v1.GetSessionLogsResponse
	42, // 60: gitops_core.v1.Core.IsCRDAvailable:output_type -> gitops_core.v1.IsCRDAvailableResponse
	1,  // 61: gitops_core.v1.Core.GetInventory:output_type -> gitops_core.v1.GetInventoryResponse
	4,  // 62: gitops_core.v1.Core.ListPolicyValidations:output_type -> gitops_core.v1.ListPolicyValidationsResponse
	6,  // 63: gitops_core.v1.Core.GetPolicyValidation:output_type -> gitops_core.v1.GetPolicyValidationResponse
