...
type FakeServerAppFactory struct {
	GetAppServiceStub        func(context.Context, apputils.AppServiceParams) (app.AppService, error)
...
func (fake *FakeServerAppFactory) recordInvocation(key string, args []interface{}) {
...
var _ apputils.ServerAppFactory = new(FakeServerAppFactory)
