...
Another common example could be provisioning platform capabilities via [profiles](../cluster-management/profiles.mdx)
...
2) Specify the [GitopsClusters](../cluster-management/managing-clusters-without-capi.mdx)
