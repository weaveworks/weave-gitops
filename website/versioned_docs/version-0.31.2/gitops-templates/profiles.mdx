...
For each profile, a sourceRef can be specified. This is the name/namespace reference to the HelmRepository where the profile can be found.
If this is not provided, `weaveworks-charts` is used by default. 
