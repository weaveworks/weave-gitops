...
```console
curl --silent --location "https://github.com/weaveworks/weave-gitops/releases/download/v0.7.0-rc13/tmp
...
```console
Current Version: v0.7.0-rc12-5-g4353c118
GitCommit: 4353c118
BuildTime: 2022-04-12_23:10:45
Branch: HEAD
```
