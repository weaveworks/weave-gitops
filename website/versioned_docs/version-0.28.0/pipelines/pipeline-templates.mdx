...
Enterprise, you can leverage [GitOpsTemplates](../gitops-templates/intro.mdx) to help platform teams scale for developer self-service.
...
#### Git credentials
For guidance on configuring credentials - see instructions in the [Promoting Applications](../promoting-applications#credentials-secret) documentation.
...
[documentation](../gitops-templates/intro.mdx).
