...
### Pre-requisites
- Install [Weave GitOps Enterprise](installation.mdx#weave-gitops-enterprise) with [TF-Controller installed](installation.mdx#optional-install-the-tf-controller) and [TLS enabled](../configuration/tls.md).
