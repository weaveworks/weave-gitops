...
This is useful if you want to make the application available alongside other applications on the same domain, please see the documentation [here](https://docs.gitops.weaveworks.org/docs/guides/run-ui-subpath/).
...
You could control where Explorer is enabled via [configuration](https://docs.gitops.weaveworks.org/docs/explorer/getting-started/#setup).
...
```yaml
    ...
    - templates
 ```
See this section of the docs for more info: https://docs.gitops.weaveworks.org/docs/explorer/getting-started/
...
Please review [monitoring](https://docs.gitops.weaveworks.org/docs/operations/monitoring/) for more info.
...
Follow [Flux](https://github.com/fluxcd/flux2/releases/tag/v2.0.0) or [Weave GitOps](https://docs.gitops.weaveworks.org/docs/guides/fluxga-upgrade/) to upgrade to Flux v2 GA before upgrading Weave GitOps Enterprise.
:::
...
#### Explorer
- You could [configure the service account](https://docs.gitops.weaveworks.org/docs/explorer/configuration/#authentication-and-authorization-for-collecting) to use for collecting resources.
...
- When enabled [useQueryServiceBackend](https://docs.gitops.weaveworks.org/docs/explorer/configuration/#setup) navigation from Clusters UI to Applications UI is not possible as Explorer does not yet support filtering.
...
- Explorer: you should configure [collector service account](https://docs.gitops.weaveworks.org/docs/explorer/configuration/#authentication-and-authorization-for-collecting) in your leaf clusters.
