...
the relationship between Flux objects and navigate to deeper levels of information as required.

Weave GitOps is an open source project sponsored by [Weaveworks](https://weave.works) - the GitOps company,
and original creators of [Flux][flux].
...
Need even more GitOps? [Weave GitOps Enterprise](./enterprise/getting-started/intro-enterprise.mdx) has all the features
...
:::tip Want to learn more about how Weave GitOps Enterprise can help your team?
Get in touch with info@weaveworks.org to discuss your needs.
:::
