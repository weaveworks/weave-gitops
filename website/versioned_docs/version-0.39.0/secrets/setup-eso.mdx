...
Follow this [guide](/secrets/bootstrapping-secrets.mdx) for bootstrapping those secrets on leaf clusters.
...
<details>
<summary>Expand to see an example that creates a new git source from a specific tag</summary>
