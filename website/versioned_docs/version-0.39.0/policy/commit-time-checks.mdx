...
<details>
<summary>Expand to view of the usage options</summary>
...
---
## Supported CI/CD
- [x] [Github](#usecase-github)
- [x] [Github Enterprise](#usecase-github)
- [x] [Gitlab](#usecase-gitlab)
- [x] [Bitbucket](#usecase-bitbucket)
- [x] [Circle CI](#usecase-circleci)
- [x] [Azure Devops](#usecase-azure-devops)
---
## Auto-Remediation
