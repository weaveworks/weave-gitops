...
- It's becoming easier to create new external secret CR through the UI instead of writing the whole CR yaml.
...
- It's all done in GitOps way. 

#### Show PR Links from Pipline details
- Users will be able to follow a link in the Pipeline Details Page to view open pull requests from given environment within their pipeline.
