...
See the Weave Gitops Enterprise [installation instructions](../installation/index.mdx#7-install-the-cli) for details on how to install the EE `gitops` CLI tool.
