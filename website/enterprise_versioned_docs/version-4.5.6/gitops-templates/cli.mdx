...
See the Weave Gitops Enterprise [installation instructions](../../../../docs/installation/weave-gitops-enterprise#7-install-the-cli) for details on how to install the EE `gitops` CLI tool.
