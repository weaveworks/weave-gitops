...
If you've followed the [Installation guide](@site/docs/installation/weave-gitops-enterprise/index.mdx) you should have:
...
<BrowserOnly>
  {() => (
    <CodeBlock className="language-bash">
      ...
      {require("@site/docs/assets/templates/capd-template.yaml").default}
    </CodeBlock>
  )}
</BrowserOnly>
