...
module.exports = {
  docs: [
    ...
    },
    {
      ...
      items: ["gitops-run/gitops-run-get-started"],
    },
    {
      type: "category",
      label: "GitOpsSets",
    ...
    },
    {
      type: "category",
      label: "Guides",
      items: ["guides/displaying-custom-metadata", "guides/fluxga-upgrade"],
    },
    {
      type: "category",
      label: "Pipelines",
          ...
          items: [
            {
              type: "category",
              label: "v1alpha1",
              items: ["pipelines/spec/v1alpha1/pipeline"],
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      items: ["progressive-delivery/flagger-manual-gating"],
    },
    {
      type: "category",
      label: "Secrets",
          ...
          items: [
            {
              type: "category",
              label: "v1alpha1",
              items: ["secrets/spec/v1alpha1/secretSync"],
            },
          ],
        },
      ],
