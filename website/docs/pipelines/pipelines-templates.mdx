...
For advice on Secrets Management, either refer to [the Flux guide](https://fluxcd.io/flux/security/secrets-management/) or contact [Weaveworks](mailto:sales@weave.works) for assistance.
