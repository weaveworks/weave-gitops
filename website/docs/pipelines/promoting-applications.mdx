...
![create token witih expiration](img/create-token-with-expiration.png)
...
![review tokens](img/manage-fine-grained.jpg)
...
Github allows to create [fine-grained access tokens](https://github.blog/2022-10-18-introducing-fine-grained-personal-access-tokens-for-github/) that improves the security context provided by classic access tokens.
