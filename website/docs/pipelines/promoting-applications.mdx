...
The pipelines controller will be creating pull requests against this repository, you will need an API token in addition to `git` credentials. You may want to create a bot account with clone and pull request permissions for this operation.
