...
6. **Reduce number of secrets to maintain**: Whenever ends in a more secure setup, favour git over https with tokens instead of ssh and deploy keys. Given that a token
