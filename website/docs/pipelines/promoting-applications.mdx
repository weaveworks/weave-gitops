...
7. **Review git provider recommendations**
...
<TabItem value="github" label="GitHub">
        Example of how to generate git secrets for github with minimal requirements
</TabItem>
<TabItem value="gitlab" label="GitLab">
    Example of how to generate git secrets for gitlab with minimal requirements
</TabItem>
</Tabs>
