...
#### Install ESO on management cluster or any existing cluster
...
### Setup SOPS on management cluster or any existing cluster

To setup SOPS on management cluster. follow this [guide](https://fluxcd.io/flux/guides/mozilla-sops/) from flux documentation.
