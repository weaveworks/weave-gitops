...
2) Specif the [GitopsClusters](https://docs.gitops.weave.works/docs/cluster-management/managing-existing-clusters/)
...
3. You have a set of GitopsClusters representing the clusters that you want to sync the secret to. They have a set of labels to allow matching.
