...
For more complete scenario see [operator](./setup-secrets-operator.mdx)
For an example with sops [XYZ](./setup-secrets-operator.mdx)
...
For other scenarios see [WZY](./setup-secrets-operator.mdx)
