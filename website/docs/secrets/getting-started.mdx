...
In order to allow you managing external secrets stores and secrets, install `external-secrets` profile
...
In order to connect with your secrets stores, install `secrets-store-config` profile
