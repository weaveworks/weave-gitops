...
For more information about how to generate OpenPGP/age keys and configure your cluster to work with Weave GitOps Enterprise secrets management follow [this](//setup-sops-page-url) guide.
...
![Create Secret SOPS](./imgs/create-secret-sops.png)
 ...
 It's important to note that the key & value inputs will be encoded to base64.
