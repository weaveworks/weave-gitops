...
The `@weaveworksoss/backstage-plugin-flux` Backstage plugin provides a set of components that you can add to your existing Backstage app that will display the state of Flux resources.

## Installation

The full installation instructions are provided in the plugin [repository](https://github.com/weaveworks/weaveworks-backstage/tree/main/plugins/backstage-plugin-flux) but you will need the [Kubernetes plugin](https://backstage.io/docs/features/kubernetes/) installed and configured to access the clusters you want to query Flux resources from.
