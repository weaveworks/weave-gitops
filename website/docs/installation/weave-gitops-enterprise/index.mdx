...
In our [Get Started document](../../getting-started/ui.mdx), we will walk you through logging into the open source version of our GitOps Dashboard and [deploying an application](../../getting-started/deploy.mdx).
