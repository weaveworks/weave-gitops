...
hide_title: true
pagination_next: getting-started/intro
---
...
In our following [Get Started document](../../getting-started/intro.mdx), we will walk you through logging into the GitOps Dashboard and deploying an application.
