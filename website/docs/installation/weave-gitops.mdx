...
# Step 1: How to Install Weave GitOps Open Source on Your Cluster
...
:::tip If you want to install an older version of Flux CLI, you can download the binary for your OS from the [releases page](https://github.com/fluxcd/flux2/releases).
:::
