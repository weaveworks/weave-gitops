...
<details><summary>Expand to see an example that creates a new GitSource</summary>
...
<details><summary>Expand to see an example that uses an existing GitSource</summary>
...
<details><summary>Expand for an example of a violating deployment</summary>
