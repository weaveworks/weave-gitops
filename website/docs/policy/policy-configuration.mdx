...
<details><summary>Expand for an example of targeting workspaces</summary>
  ```yaml
    match:
      workspaces:
      - team-a
...
<details><summary>Expand for an example of targeting namespaces</summary>
  ```yaml
    match:
      namespaces:
      - dev
...
<details><summary>Expand for an example of targeting applications</summary>
  ```yaml
    match:
...
<details><summary>Expand for an example of targeting resources</summary>
  ```yaml
    match:
...
<details><summary>Expand for an example of overriding policy parameters</summary>
  ```yaml
    config:               # config for policies [one or more]
