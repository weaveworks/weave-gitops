...
### Prerequisites
- Install [Weave GitOps Enterprise](../enterprise/getting-started/install-enterprise.mdx)
- Install [Terraform Controller](../terraform/get-started-terraform.mdx) and [TLS enabled](../configuration/tls.md).
