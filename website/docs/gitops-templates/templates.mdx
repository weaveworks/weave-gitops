...
The `templates.weave.works/create-request` annotation includes the pull request details of the template as a json string.
...
- `editable` - whether the parameter value can be edited after creation or not
