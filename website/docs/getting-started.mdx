...
Clicking on `Flux Runtime` provides two different tabs: controllers, and CRDs.

#### Controllers

The controllers tab shows your installed GitOps Toolkit Controllers which are working to and their version.
