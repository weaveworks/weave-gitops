...
in [setup RBAC](../enterprise/getting-started/install-enterprise/#gitops-dashboard-service-account-permissions.mdx), the GitopsCluster service account is able to impersonate any user or group.
