...
1. The read path or querying is exercised when a weave gitops user queries the data.
2. The write path or collecting is exercised to gather the resources from the leaf clusters.
