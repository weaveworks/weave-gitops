...
labels:
- Cluster: name of the cluster (ie: management).
- Status: cluster watcher status. It could be any of the following: Started, Starting, Stopped, Stopping, Failed.

```
collector_cluster_watcher{cluster="management", status="Failed"} 0
collector_cluster_watcher{cluster="management", status="Started"} 1
collector_cluster_watcher{cluster="management", status="Starting"} 0
collector_cluster_watcher{cluster="management", status="Stopped"} 0
collector_cluster_watcher{cluster="management", status="Stopping"} 0
```
