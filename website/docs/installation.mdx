...
However Weave Gitops Enterprise supports any combination of management cluster and CAPI provider. Please see the [Sizing Guidelines](/docs/enterprise/wge_sizing)
