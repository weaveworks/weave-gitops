...
If you followed the [installation instructions](../installation/weave-gitops.mdx) you don't need to perform any additional steps to enable this login method. You will be able to login to the dashboard using the credentials generated in the installation step.
