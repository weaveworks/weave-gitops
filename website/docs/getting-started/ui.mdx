...
1. [Open the dashboard](http://localhost:9001/) and login using either the [emergency cluster user](../configuration/emergency-user.mdx)
	...
	If you followed the example above, the emergency user will be configure, with the username set to `admin`,
	and the password to the non-encrypted value you provided as `$PASSWORD`.
