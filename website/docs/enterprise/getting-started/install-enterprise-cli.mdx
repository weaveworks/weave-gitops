...
- `--repo-url`:                     Git repo URL for your Flux repository. The repo URL should include the scheme, for example `ssh://git@github.com/my-org-name/my-repo-name` or `https://github.com/my-org-name/my-repo-name`
