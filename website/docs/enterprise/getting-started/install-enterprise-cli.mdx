...
1. **Interactive:** guides you step-by-step through the process until Weave GitOps Enterprise is up and running. Ideal for Day 0 scenarios.
2. **Non-interactive:** for your automated workflows where you are already familiar with install process and have the configuration. Ideal for Day 1 scenarios.
