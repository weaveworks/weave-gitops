...
to define what actions can a subject do-over the existing resources. The following Weave GitOps subjects needs authorization:
...
This section introduces the default authorization context created, for each subject, out of installing Weave GitOps Enterprise Helm Release with the default values.
It also expands on how you could customise it.
