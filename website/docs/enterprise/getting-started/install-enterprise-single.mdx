...
- [ ] **Git Repository**: you have a Git repository that you want to bootstrap.
- [ ] **Management Cluster**: you have a Kubeconfig pointing to the Kubernetes cluster that you want to use as Management Cluster.
- [ ] **CLI Tools**: you have installed Flux and Weave GitOps Enterprise CLI.
- [ ] **Weave GitOps Enterprise Entitlements**: you have contacted [Sales](/help-and-support/) and have the Weave GitOps Enterprise Entitlements Kubernetes Secret.
...
In the case that you want just to generate the manifests but don't apply them, you could use the cli route and the `--export` flag.
:::
...
Your Day 0 is about getting Weave GitOps Enterprise up and running quickly by going through the following steps:

1. [Bootstrap Flux](#bootstrap-flux)
2. [Entitlements](#verifying-entitlement)
3. [Authentication & Authorization](#create-cluster-user)
4. [Install WGE](#configure-dashboard-access)
5. [Access the dashboard](#access-the-dashboard)

You could do it in any of the following ways:

- `CLI Interactive`: ideal if you have limited knowledge about Weave GitOps Enterprise and you want guidance step-by-step.
