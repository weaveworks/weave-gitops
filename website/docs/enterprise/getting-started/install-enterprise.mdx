...
Generally speaking, you do not need to install a CAPI provider to provision Kubernetes clusters using Weave GitOps Enterprise. But for this example with CAPA, you must.
