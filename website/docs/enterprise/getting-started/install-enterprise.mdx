...
Alone, this is an **insecure** method of securing your dashboard. It is designed to be used with other external authentication systems like auth proxies.
...
for the [emergency user](../../configuration/emergency-user.mdx), and the latter holds OIDC configuration.
