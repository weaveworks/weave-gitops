...
### Day 1: Onboard the team

[**Onboard Platform Engineers**](../install-enterprise-onboard-platform-engineers): you want to harden your setup to onboard other Platform Engineers. Other Platform Engineers setup any WGE capabilities for your devs.

[**Onboard Developers**](../install-enterprise-onboard-platform-engineers): the platform capabilities have been setup and you ready to start onboard developers.
