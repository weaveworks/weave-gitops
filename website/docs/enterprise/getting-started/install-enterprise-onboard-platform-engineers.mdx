...
<details>
<summary>Expand to see RBAC Configuration</summary>
...
Once you have the rules defined, you want to ensure they are available in your environment. The `bases` pattern is useful approach
